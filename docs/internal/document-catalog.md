...
| `docs/internal/architecture/permissions-refactor-audit-outline.md` | Internal engineers | Timestamped permissions audit snapshot to guide refactor/restructure work | Medium | Working outline only; not canonical source of truth |
