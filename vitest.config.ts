...
export default defineConfig({
  resolve: {
    ...
    alias: [
      ...
      {
        find: "@mobile-data",
        replacement: path.resolve(__dirname, "apps/mobile/src/data"),
      },
      {
        find: /^@mobile-data\/(.*)/,
        replacement: path.resolve(__dirname, "apps/mobile/src/data/$1"),
      },
      ...
      {
        find: /^react$/,
        replacement: path.resolve(__dirname, "apps/mobile/node_modules/react"),
      },
      {
        find: /^react\/(.*)/,
        replacement: path.resolve(
          __dirname,
          "apps/mobile/node_modules/react/$1",
        ),
      },
      {
        ...
        replacement: path.resolve(
          __dirname,
          "apps/mobile/node_modules/use-sync-external-store/shim/with-selector.js",
        ),
      },
      ...
      // packages/shared may import) still resolves from the root install.
      {
        ...
        replacement: path.resolve(
          __dirname,
          "apps/mobile/node_modules/zustand/traditional",
        ),
      },
      {
        find: /^zustand$/,
        replacement: path.resolve(
          __dirname,
          "apps/mobile/node_modules/zustand",
        ),
      },
      {
        find: "@solid-client",
  ...
  test: {
    ...
    environment: "node",
    setupFiles: [
      "tooling/test-support/setup/env.ts",
      "tooling/test-support/setup/jsdom.ts",
    ],
    include: [
      "apps/**/*.test.ts",
      "apps/**/*.test.tsx",
