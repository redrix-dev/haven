-- Add dedicated permission for viewing ban-hidden messages.

insert into public.permissions_catalog (key, description)
values ('can_view_ban_hidden', 'View messages hidden by community bans')
...
select rsr.id, 'can_view_ban_hidden'
