...
export type UxLabJsStackParamList = {
  UxLabHome: undefined;
...
const Stack = createStackNavigator<UxLabJsStackParamList>();

export function UxLabJsStack() {
  const cardStyle = useResolveClassNames("bg-background");
