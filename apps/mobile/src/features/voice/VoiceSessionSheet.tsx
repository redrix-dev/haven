...
function ParticipantTile({ participant, self = false }: ParticipantTileProps) {
  return (
    <View className="w-[48%] items-center gap-2 rounded-lg bg-surface-panel px-3 py-4">
      ...
      />
      <Text
        className="w-full text-center text-sm font-semibold text-foreground"
        numberOfLines={1}
      >
    ...
    >
      <View className="gap-5">
        ...
        <View className="flex-row flex-wrap justify-between gap-y-3">
          {state.joined ? (
            <ParticipantTile participant={currentUserParticipant} self />
          ) : null}
        ...
        <View className="flex-row gap-2">
          ...
          <ControlButton
            ...
            icon={
              state.isDeafened ? "volume-mute-outline" : "volume-high-outline"
            }
              ...
              return (
                ...
                >
                  ...
                  <Pressable
                    ...
                    className="h-9 w-9 items-center justify-center rounded-lg bg-surface-embedded active:bg-surface-hover"
                    onPress={() =>
                      actions.setMemberVolume(participant.userId, volume - 10)
                    }
                  >
                    <ThemedIonicons
                      name="remove"
