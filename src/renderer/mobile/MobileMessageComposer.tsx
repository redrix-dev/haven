...
import { X, Plus, Smile, Bold, Italic, Strikethrough, Code, Quote, Type } from 'lucide-react';
    ...
    >
      ...
      <div className="px-3 py-2" style={{ touchAction: 'none' }}>
        <div className="mx-auto w-full max-w-[24rem]" style={{ touchAction: 'none' }}>
          <div
            className="relative rounded-[1.4rem] border border-white/10 bg-white/5 transition-colors focus-within:border-blue-500/50 flex items-end gap-1 px-2 py-1.5"
            style={{ touchAction: 'none' }}
          >
            {/* + Attachment button */}
            <button
              ...
              className="shrink-0 flex items-center justify-center w-8 h-8 rounded-full text-gray-400 hover:bg-white/10 hover:text-gray-200 transition-colors mb-0.5"
            >
            ...
            <textarea
              ...
              inputMode="text"
              autoComplete="off"
              className="flex-1 resize-none bg-transparent py-1.5 text-base leading-relaxed text-white placeholder-gray-500 focus:outline-none disabled:opacity-50"
            ...
            <button
              type="button"
              onClick={() => { setShowFormatting((v) => !v); setShowEmoji(false); }}
              aria-label="Toggle formatting"
              aria-pressed={showFormatting}
              className={`shrink-0 flex items-center justify-center w-8 h-8 rounded-full transition-colors mb-0.5 ${
                showFormatting
            ...
            <button
              type="button"
              onClick={() => { setShowEmoji((v) => !v); setShowFormatting(false); }}
              aria-label="Emoji"
              className={`shrink-0 flex items-center justify-center w-8 h-8 rounded-full transition-colors mb-0.5 ${
                showEmoji
                  ? 'bg-blue-600/30 text-blue-400'
            ...
            <button
              ...
              className="shrink-0 flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white transition-colors disabled:bg-white/10 disabled:text-gray-500 mb-0.5"
            >
