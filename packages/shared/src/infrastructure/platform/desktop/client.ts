...
import type { UpdaterStatus, SaveFileFromUrlResult, VoicePopoutControlAction, VoicePopoutState, DesktopAPI } from '@shared/infrastructure/platform/desktop/types';
