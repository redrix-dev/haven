...
| `useChatAppAccessAndBroadcastOrchestration` | Server/channel access loss, voice disconnect toasts, realtime ban/revoke broadcasts; registers handlers via `registerCommunityAccessHandlers` in `@shared/core`. |
