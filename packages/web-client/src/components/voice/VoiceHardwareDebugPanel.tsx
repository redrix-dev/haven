...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@shared/app/ui/card';
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from '@shared/app/ui/dialog';
import { Progress } from '@shared/app/ui/progress';
import {
  Select,
  SelectContent,
  SelectItem,
