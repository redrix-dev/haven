...
try {
  ...
  const mobileReusablesThemePath =
  ...
  const beforeMobileUniwindTypes = fs.readFileSync(
    mobileUniwindTypesPath,
    "utf8",
  );
  const beforeMobileReusablesTheme = fs.readFileSync(
    mobileReusablesThemePath,
    "utf8",
  );
  ...
  const afterMobileUniwindTypes = fs.readFileSync(
    mobileUniwindTypesPath,
    "utf8",
  );
  const afterMobileReusablesTheme = fs.readFileSync(
    mobileReusablesThemePath,
    "utf8",
  );
  if (
