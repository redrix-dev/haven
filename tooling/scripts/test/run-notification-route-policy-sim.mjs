...
// Mirrors the logic in packages/shared/src/lib/notifications/routePolicy.ts (kept intentionally close).
...
function printHelp() {
  console.log(`Usage: node tooling/scripts/test/run-notification-route-policy-sim.mjs [options]
